...
from .parsers import welcome_parser, history_response_parser, \
    procedure_parser, guardrail_parser, aggregate_response_parser, \
    analysis_parser, rewrite_with_history_parser, ask_again_parser
from .prompts import welcome_prompt, history_prompt, \
    procedure_selector_prompt, guardrail_prompt, aggregate_prompt, \
    analysis_prompt, rewrite_with_history_prompt, ask_again_prompt
...
def get_prompt_by_task(task: str):
    if task == "guardrail":
    ...
    elif task == "rewrite_with_history":
        parser = rewrite_with_history_parser
        prompt_template = rewrite_with_history_prompt 
        ...
        parser = ask_again_parser
        prompt_template = ask_again_prompt
